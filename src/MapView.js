...
function MapView() {
    ...
    const handleRequest = (e) => {
        ...
        const url = `https://exam.pishgamanasia.com/webapi/Request/GetVehicleUsers?SearchTerm=${'%D8%B3%D9%88%D8%A7%D8%B1&User'}Token=${'39476ad1'}`
        axios.get('https://exam.pishgamanasia.com/webapi/Request/GetVehicleUsers?SearchTerm='+'%D8%B3%D9%88%D8%A7%D8%B1&User'+'Token='+'39476ad1')
        // axios.get(url)
            .then(response => {
                ...
                axios.post("https://exam.pishgamanasia.com/webapi/Request/SendRequest", userData).then((response) => {
                    ...
                    setOpen(false)
                    alert(response.data.data.requestNo)
                });
